...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.maxsize(width=1380, height=700)
        self.root.minsize(width=1380, height=700)
...
# =======
    ...
    def welcome_soft(self):
        ...
        self.txt.insert(END, "Welcome To Dharm's Retail\n")
    ...
    def bill_area(self):
        ...
        if self.biscuits.get() != 0:
            self.txt.insert(END, f"\nBiscuit{self.biscuits.get()}{self.biscuits.get() * 20}")
        self.txt.insert(END, "\n===================================")
